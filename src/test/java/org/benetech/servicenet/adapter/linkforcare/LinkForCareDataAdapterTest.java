...
public class LinkForCareDataAdapterTest {
    ...
    private void assertService(ProviderServiceDTO service) {
        ...
        assertEquals("In Center Hemodialysis, In Center Nocturnal Dialysis, "
                + "In Home Non Medical Services, In Unit Washer and Dryer, "
                + "Laundry Services, Licensed Practical Nurses, "
                + "Licensed Professional Counselor, "
                + "Licensed Staff on Duty 24/7, "
                + "Light Housekeeping, "
                + "Live In Care, "
