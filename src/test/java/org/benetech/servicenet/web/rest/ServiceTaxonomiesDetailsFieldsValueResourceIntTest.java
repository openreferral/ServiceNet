...
public class ServiceTaxonomiesDetailsFieldsValueResourceIntTest {
    ...
    private static final ServiceTaxonomiesDetailsFields DEFAULT_SERVICE_TAXONOMIES_DETAILS_FIELD = ServiceTaxonomiesDetailsFields.TAXONOMY_NAME;
    private static final ServiceTaxonomiesDetailsFields UPDATED_SERVICE_TAXONOMIES_DETAILS_FIELD = ServiceTaxonomiesDetailsFields.TAXONOMY_DETAILS;
    ...
    public void setup() {
        ...
        final ServiceTaxonomiesDetailsFieldsValueResource serviceTaxonomiesDetailsFieldsValueResource = new ServiceTaxonomiesDetailsFieldsValueResource(serviceTaxonomiesDetailsFieldsValueService);
        this.restServiceTaxonomiesDetailsFieldsValueMockMvc = MockMvcBuilders.standaloneSetup(serviceTaxonomiesDetailsFieldsValueResource)
    ...
    public void createServiceTaxonomiesDetailsFieldsValue() throws Exception {
        ...
        List<ServiceTaxonomiesDetailsFieldsValue> serviceTaxonomiesDetailsFieldsValueList = serviceTaxonomiesDetailsFieldsValueRepository.findAll();
        assertThat(serviceTaxonomiesDetailsFieldsValueList).hasSize(databaseSizeBeforeCreate + 1);
        ServiceTaxonomiesDetailsFieldsValue testServiceTaxonomiesDetailsFieldsValue = serviceTaxonomiesDetailsFieldsValueList.get(serviceTaxonomiesDetailsFieldsValueList.size() - 1);
        assertThat(testServiceTaxonomiesDetailsFieldsValue.getServiceTaxonomiesDetailsField()).isEqualTo(DEFAULT_SERVICE_TAXONOMIES_DETAILS_FIELD);
    }
    ...
    public void getNonExistingServiceTaxonomiesDetailsFieldsValue() throws Exception {
        // Get the serviceTaxonomiesDetailsFieldsValue
        restServiceTaxonomiesDetailsFieldsValueMockMvc.perform(get("/api/service-taxonomies-details-fields-values/{id}", TestConstants.NON_EXISTING_UUID))
    ...
    public void updateServiceTaxonomiesDetailsFieldsValue() throws Exception {
        ...
        ServiceTaxonomiesDetailsFieldsValue updatedServiceTaxonomiesDetailsFieldsValue = serviceTaxonomiesDetailsFieldsValueRepository.findById(serviceTaxonomiesDetailsFieldsValue.getId()).get();
        // Disconnect from session so that the updates on updatedServiceTaxonomiesDetailsFieldsValue are not directly saved in db
        ...
        ServiceTaxonomiesDetailsFieldsValue testServiceTaxonomiesDetailsFieldsValue = serviceTaxonomiesDetailsFieldsValueList.get(serviceTaxonomiesDetailsFieldsValueList.size() - 1);
        assertThat(testServiceTaxonomiesDetailsFieldsValue.getServiceTaxonomiesDetailsField()).isEqualTo(UPDATED_SERVICE_TAXONOMIES_DETAILS_FIELD);
    }
    ...
    public void equalsVerifier() throws Exception {
        ...
        ServiceTaxonomiesDetailsFieldsValue serviceTaxonomiesDetailsFieldsValue1 = new ServiceTaxonomiesDetailsFieldsValue();
        serviceTaxonomiesDetailsFieldsValue1.setId(TestConstants.UUID_1);
        ServiceTaxonomiesDetailsFieldsValue serviceTaxonomiesDetailsFieldsValue2 = new ServiceTaxonomiesDetailsFieldsValue();
    ...
    public void dtoEqualsVerifier() throws Exception {
        ...
        ServiceTaxonomiesDetailsFieldsValueDTO serviceTaxonomiesDetailsFieldsValueDTO1 = new ServiceTaxonomiesDetailsFieldsValueDTO();
        serviceTaxonomiesDetailsFieldsValueDTO1.setId(TestConstants.UUID_1);
        ServiceTaxonomiesDetailsFieldsValueDTO serviceTaxonomiesDetailsFieldsValueDTO2 = new ServiceTaxonomiesDetailsFieldsValueDTO();
    ...
    public void testEntityFromId() {
        assertThat(serviceTaxonomiesDetailsFieldsValueMapper.fromId(TestConstants.UUID_42).getId()).isEqualTo(TestConstants.UUID_42);
