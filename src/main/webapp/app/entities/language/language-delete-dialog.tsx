...
export class LanguageDeleteDialog extends React.Component<ILanguageDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.languageEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="serviceNetApp.language.delete.question">
          <Translate contentKey="serviceNetApp.language.delete.question" interpolate={{ id: languageEntity.id }}>
