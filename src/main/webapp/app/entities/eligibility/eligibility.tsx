...
import { getEntities, updateEntity } from './eligibility.reducer';
...
export interface IEligibilityState extends IPaginationBaseState {
  dropdownOpenTop: boolean;
  dropdownOpenBottom: boolean;
  itemsPerPage: number;
}

export class Eligibility extends React.Component<IEligibilityProps, IEligibilityState> {
  constructor(props) {
    super(props);
  ...
  render() {
    const { eligibilityList, match, totalItems } = this.props;
    return (
      <div>
