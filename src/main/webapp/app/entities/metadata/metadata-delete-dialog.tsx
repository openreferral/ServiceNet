...
export class MetadataDeleteDialog extends React.Component<IMetadataDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.metadataEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="serviceNetApp.metadata.delete.question">
          <Translate contentKey="serviceNetApp.metadata.delete.question" interpolate={{ id: metadataEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-metadata" color="danger" onClick={this.confirmDelete}>
