...
export class OrganizationDeleteDialog extends React.Component<IOrganizationDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.organizationEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="serviceNetApp.organization.delete.question">
          <Translate contentKey="serviceNetApp.organization.delete.question" interpolate={{ id: organizationEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-organization" color="danger" onClick={this.confirmDelete}>
