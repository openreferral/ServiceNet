...
import { getEntities, reset } from './organization-error.reducer';
...
export class OrganizationError extends React.Component<IOrganizationErrorProps, IOrganizationErrorState> {
  ...
  render() {
    const { organizationErrorList, match } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ organizationError }: IRootState) => ({
  ...
  links: organizationError.links,
  entity: organizationError.entity,
  updateSuccess: organizationError.updateSuccess
});
