...
export interface ITaxonomyState extends IPaginationBaseState {
...
export class Taxonomy extends React.Component<ITaxonomyProps, ITaxonomyState> {
  ...
  render() {
    const { taxonomyList, match, totalItems } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ taxonomy }: IRootState) => ({
  ...
  totalItems: taxonomy.totalItems
});
