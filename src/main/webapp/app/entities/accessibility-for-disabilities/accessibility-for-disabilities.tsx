...
import { getEntities } from './accessibility-for-disabilities.reducer';
...
export class AccessibilityForDisabilities extends React.Component<IAccessibilityForDisabilitiesProps> {
  componentDidMount() {
    this.props.getEntities();
  }

  render() {
    const { accessibilityForDisabilitiesList, match } = this.props;
    return (
      <div>
