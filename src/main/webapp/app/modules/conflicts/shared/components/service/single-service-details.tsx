...
import ServiceMatchesDetails from 'app/modules/conflicts/shared/components/service/service-matches-details';
...
const mapStateToProps = state => ({
  baseService: state.sharedRecordView.openService
});
