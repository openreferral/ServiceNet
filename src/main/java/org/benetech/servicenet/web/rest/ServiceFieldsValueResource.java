...
public class ServiceFieldsValueResource {
    ...
    public ResponseEntity<List<ServiceFieldsValueDTO>> getAllServiceFieldsValues(Pageable pageable) {
        log.debug("REST request to get all ServiceFieldsValues");
        Page<ServiceFieldsValueDTO> page = serviceFieldsValueService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/service-fields-values");
