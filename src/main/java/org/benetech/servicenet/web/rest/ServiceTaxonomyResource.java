...
public class ServiceTaxonomyResource {
    ...
    @Timed
    public List<ServiceTaxonomyDTO> getAllServiceTaxonomies() {
        log.debug("REST request to get all ServiceTaxonomies");
        return serviceTaxonomyService.findAll();
    }
    ...
    @Timed
    public ResponseEntity<ServiceTaxonomyDTO> getServiceTaxonomy(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteServiceTaxonomy(@PathVariable Long id) {
