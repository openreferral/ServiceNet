...
public class PostalAddressFieldsValueResource {
    ...
    public ResponseEntity<List<PostalAddressFieldsValueDTO>> getAllPostalAddressFieldsValues(
        Pageable pageable) {
        log.debug("REST request to get all PostalAddressFieldsValues");
        Page<PostalAddressFieldsValueDTO> page = postalAddressFieldsValueService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/postal-address-fields-values");
