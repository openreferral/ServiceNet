...
public class ServiceTaxonomiesDetailsFieldsValueResource {
    ...
    public List<ServiceTaxonomiesDetailsFieldsValueDTO> getAllServiceTaxonomiesDetailsFieldsValues() {
        log.debug("REST request to get all ServiceTaxonomiesDetailsFieldsValues");
        return serviceTaxonomiesDetailsFieldsValueService.findAll();
    }
