...
public class LocationBasedImportServiceImpl implements LocationBasedImportService {
    ...
    @Override
    @ConfidentialFilter
    public void createOrUpdatePhysicalAddress(PhysicalAddress physicalAddress, Location location) {
    ...
    @Override
    @ConfidentialFilter
    public void createOrUpdatePostalAddress(PostalAddress postalAddress, Location location) {
    ...
    @Override
    public void createOrUpdateOpeningHoursForLocation(RegularSchedule schedule, Location location) {
        if (schedule != null) {
    ...
    @Override
    public void createOrUpdateLangsForLocation(Set<Language> langs, Location location) {
    ...
    @Override
    public void createOrUpdatePhonesForLocation(Set<Phone> phones, Location location) {
